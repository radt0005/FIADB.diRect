# PLOT_obs_w_filter.R provides a convenience wrapper for retrieving
# FIA plot-level observations using user-specified filter criteria.
#
...
#'
#' @return
#' A data frame containing filtered plot-level observations and
...
PLOT_obs_w_filter <- function(EVAL_GRP, ATTRIBUTE_NBR, GRP_BY_ATTRIB="CN", SCHEMA = "FS_FIADB",
                              VAR_NAMES = NA, VAR_VALUES = NA, VAR_CONDS = NA, VAR_BOOLS = NA,
                              dbname = "fiadb"){ 
  #Aakriti 01/13/2025
